...
{
	data->tex[0].img_ptr = mlx_xpm_file_to_image(data->mlx,
	...
	&data->tex[0].endian);
	data->tex[1].img_ptr = mlx_xpm_file_to_image(data->mlx,
	...
	&data->tex[1].endian);
	data->tex[2].img_ptr = mlx_xpm_file_to_image(data->mlx,
	...
	&data->tex[2].endian);
	data->tex[3].img_ptr = mlx_xpm_file_to_image(data->mlx,
	...
	&data->tex[3].endian);
	data->tex[4].img_ptr = mlx_xpm_file_to_image(data->mlx,
